...
$appid = 'wx624f7eef92fcc2ab';  //微信支付申请对应的公众号的APPID
$appKey = 'bab9697b99dd4c57b2f9922df0e0fddb';   //微信支付申请对应的公众号的APP Key
...
$orderName = '支付测试';    //订单标题
$notifyUrl = 'http://www.zzw0527.com/weixin/notify.php';     //付款成功后的回调地址(不要有问号)
$payTime = time();      //付款时间
